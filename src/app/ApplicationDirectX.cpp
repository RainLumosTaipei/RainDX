...
void RainDX::Application::OnMouseDown(WPARAM btnState, int x, int y)
{
}

void RainDX::Application::OnMouseUp(WPARAM btnState, int x, int y)
{
}

void RainDX::Application::OnMouseMove(WPARAM btnState, int x, int y)
{
}
